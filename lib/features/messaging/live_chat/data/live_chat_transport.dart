...
/// (web, Android, iOS — platforms with no bridge process).
library;
...
/// platform (web, Android, iOS) uses [LiveChatTransportMode.cloudRemote].
/// Uses the same `kIsWeb` / `defaultTargetPlatform` client-platform check
/// already established by `zalo_integration_provider.dart` and
