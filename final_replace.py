...
if start_idx != -1:
    # Everything from start_idx to the end, except the last bracket
    # Wait, instead of slicing blindly, let's just use regex to replace it until the end of the class

    old_section_pattern = r"  Widget _buildCampaignStatusSection\(DashboardState state\) \{.*\}(?=\s*\Z)"
