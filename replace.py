...
# 1. Replace _buildCampaignStatusDonut
old_donut = r"  // --- Campaign Status Donut Chart ---.*?Widget _buildRecentPerformanceBarChart"
new_donut = '''  // --- Campaign Status Donut Chart ---
  ...
  Widget _buildRecentPerformanceBarChart'''
content = re.sub(old_donut, new_donut, content, flags=re.DOTALL)


# 2. Replace _buildRecentPerformanceBarChart
old_bar = r"  // --- Recent Performance Bar Chart ---.*?Widget _buildTopPerformersList"
new_bar = '''  // --- Recent Performance Bar Chart ---
