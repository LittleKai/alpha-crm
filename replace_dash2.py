...
# Replace _buildCampaignStatusSection with my new combined charts
old_section = r"  Widget _buildCampaignStatusSection\(DashboardState state\) \{.*?(?=  Widget _buildQuickActionsSection)"
...
new_content = new_content.replace("_buildCampaignStatusSection(state)", "_buildCampaignStatusAndPerformance(state)")
